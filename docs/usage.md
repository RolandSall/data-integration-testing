# Setup and lifecycle guide

Complete setup instructions for `@integration-testing/data-isolation`. For runnable projects,
see the [examples table](https://github.com/RolandSall/data-integration-testing#examples).
...
## Testcontainers resource handoff
...
Use the shared runtime launcher or manual global setup shown above. Generated file setup,
including dedicated containers, needs additional lifecycle coordination; see the handoff notes below.
...
The explicit runtime launcher and `requiredContainers` global-setup examples above need only
...
global-setup examples above restore the shared resources through the exported Vitest context key
...
ordinary hooks may be sufficient; the [handwritten comparison](https://github.com/RolandSall/data-integration-testing/tree/main/examples/nestjs-inventory#compare-with-ordinary-hooks)
